#ifndef CAMERASCREENVM_H
#define CAMERASCREENVM_H
...
class CameraScreenVM : public QAbstractVideoFilter
{
    ...
    public:  /// Methods
        explicit CameraScreenVM(QObject *parent = 0);
        virtual ~CameraScreenVM();
...
class QZXingFilterRunnable : public QObject, public QVideoFilterRunnable
{
    ...
    public:
        explicit QZXingFilterRunnable(CameraScreenVM * filter);
    ...
    private:
        CameraScreenVM * filter;
};


#endif // CAMERASCREENVM_H
